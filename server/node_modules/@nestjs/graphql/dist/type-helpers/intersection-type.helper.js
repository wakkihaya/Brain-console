...
function IntersectionType(classARef, classBRef, decorator) {
    ...
    fields.forEach((item) => {
        decorators_1.Field(item.typeFn, { ...item.options })(IntersectionObjectType.prototype, item.name);
        type_helpers_utils_1.applyFieldDecorators(IntersectionObjectType, item);
    });
