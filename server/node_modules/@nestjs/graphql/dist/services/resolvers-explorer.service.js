        ...
        if (subscriptionOptions && subscriptionOptions.filter) {
            return {
                ...
                callback: {
                    ...
                    subscribe: (...args) => async_iterator_util_1.createAsyncIterator(createSubscribeContext()(...args), (payload) => subscriptionOptions.filter.call(instanceRef, payload, ...args.slice(1))),
                },
            };
        }
        return {
